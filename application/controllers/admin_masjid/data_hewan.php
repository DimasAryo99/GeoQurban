...
class data_hewan extends CI_Controller
{
    public function index()
    {
        ...
        $data["hewan_dropdown"] = "";
        $this->load->view("admin_masjid/data-hewan", $data);
    ...
    public function tambahhewan()
    {
        ...
        redirect('admin_masjid/data_hewan/index');
    }
    ...
    public function tampilan_edit_hewan($id)
    {
        ...
        $this->load->view('template_admin/sidebar');
        $this->load->view('template_admin/footer');
        $this->load->view('admin_masjid/edit-data-hewan', $data);
    }
    ...
    public function tampilan_edit_hewan_masjid($id)
    {
        ...
        $this->load->view('template_admin/sidebar');
        $this->load->view('template_admin/footer');
        $this->load->view('admin_masjid/edit-data-hewan-masjid', $data);
    }
    ...
    public function filter_masjid($id)
    {
        ...
        $this->load->view("admin_majid/data-hewan", $data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function update_hewan_filter($id_masjid)
    {
        ...
        redirect('admin_masjid/data_hewan/filter_masjid/'.$id_masjid);
    }
    ...
    public function delete_filter($id = null)
    {
        ...
        if ($this->m_hewan_model->delete_filter($id, "hewan_masjid")) {
            redirect(site_url('admin_masjid/data_hewan/index'));
        }
    }
}
