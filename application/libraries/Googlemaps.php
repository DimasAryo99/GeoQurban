...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyA9vGmYGF7rTSKaV4HefJZqcGxyr5hZQHQ'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_div_id					= "map-canvas";				// The ID of the <div></div> that is output which contains the map
