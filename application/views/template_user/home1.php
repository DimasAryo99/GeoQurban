...
<body>
  ...
  <div-- id="video" class="our-videos section">
    ...
    <!-- <div id="map">
                            <iframe src="https://maps.google.com/maps?q=Av.+L%C3%BAcio+Costa,+Rio+de+Janeiro+-+RJ,+Brazil&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="1080px" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                        </div> -->
    <!--div class="info">
