                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $hewans->jumlah_hewan ?></td>
                                    <td width="150px">
                                        <a href="<?php echo site_url('admin_masjid/datwan_admin/tampilan_edit_hewan/' . $hewans->id_hewan) ?>" class="btn btn-primary btn-sm mb-2"><i class="fa fa-edit"></i></a>
                                        <a onclick="deleteConfirm('<?php echo site_url('admin_masjid/datwan_admin/delete/' . $hewans->id_hewan) ?>')" href="#!" class="btn btn-danger btn-sm mb-2"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
