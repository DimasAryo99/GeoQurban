<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <form method="POST" action="<?= base_url() . 'admin_masjid/datmas_admin/updatemasjid' ?>">
            ...
            <br>
            <a href='<?= base_url('admin_masjid/datmas_admin/index') ?>' type="button" class="btn btn-danger">Close</a>
